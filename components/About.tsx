...
const About = () => {
  return (
    <div id='about' className='grid grid-cols-1 sm:grid-cols-2 pt-12 gap-8 place-items-center text-darker dark:text-lighter'>
      ...
      <p className="leading-7 text-base col-span-2 text-justify font-extralight">
